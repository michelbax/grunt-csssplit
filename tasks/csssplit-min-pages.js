...
module.exports = function(grunt) {
    ...
    function cssFileToPages(options, filePath) {
        var dividedPages = options.minPages !== false ? options.minPages - 1 : 1;
        return {
            original: path.basename(filePath),
            pages: checkPageCount(splitter.split(grunt.file.read(filePath), (options.maxSelectors / dividedPages)), options, filePath)
        };
    }
