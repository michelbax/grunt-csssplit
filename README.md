...
IE9 has a per file selector limit of 4096. Why? Because Bill hates you that's why.
grunt-csssplit makes use of css-parse from the reworkcss project to split css files
